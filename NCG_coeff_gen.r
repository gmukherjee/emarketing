...
###################################################################
params = read.table("NCG_learning_output.txt");
...
write.csv(gg, "NCG_parameter_open.csv", row.names=F, quote=F);

write.csv(gg1, "NCG_parameter_click.csv", row.names=F, quote=F);

write.csv(gg2, "NCG_parameter_purchase.csv", row.names=F, quote=F);

write.csv(sig_est, "NCG_parameter_correlation.csv", row.names=F, quote=F);

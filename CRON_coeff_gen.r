...
###################################################################
params = read.table("CRON_learning_output.txt");
...
write.csv(gg, "CRON_parameter_open.csv", row.names=F, quote=F);

write.csv(gg1, "CRON_parameter_click.csv", row.names=F, quote=F);

write.csv(gg2, "CRON_parameter_purchase.csv", row.names=F, quote=F);

write.csv(sig_est, "CRON_parameter_correlation.csv", row.names=F, quote=F);
